    ...
    stages {
        ...
        stage ('DAST') {
            steps {
                ...
                docker run --rm -u root -v /path/on/host:/zap zaproxy/zap-stable sh -c "mkdir -p /zap/wrk && chmod -R 777 /zap/wrk && zap-baseline.py -t http://18.197.52.92:8080/webapp -r /zap/zap_report.html"
